let red = ["Absolution of Inspiring",
...
let green = ["Animate Weapon of Ranged Arms",
...
fetch(
    ...
    myData.lines.forEach(element => {
        if (element.tradeFilter != undefined && element.corrupted == undefined && element.gemLevel == 1 && element.gemQuality == 20)
    ...
    console.log("red " + redCombined + "chaos average per gem is " + redCombined / red.length)
    console.log("green " + greenCombined + "chaos average per gem is " + greenCombined / green.length)
    console.log("blue " + blueCombined + "chaos average per gem is " + blueCombined / blue.length)
});
